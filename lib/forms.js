...
module.exports = class Forms extends OneBlinkAPI {
  ...
  */
  constructor (
    ...
    if (typeof options.formsRendererOrigin !== 'string') {
      throw new TypeError('Must supply "formsRendererOrigin" as a string')
    }
    this.formsRendererOrigin = options.formsRendererOrigin
  }
