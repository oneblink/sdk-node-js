...
function validateWithFormSchema (form /* : mixed */) /* : Form */ {
  const validatedForm = validateJoiSchema(form, formSchema, { stripUnknown: true })
  return validatedForm
}

function validateWithElementSchema (element /* : mixed */) /* : FormElement */ {
  const validatedElement = validateJoiSchema(element, elementSchema, { stripUnknown: true })
